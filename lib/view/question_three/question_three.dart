...
//import 'package:quizapp_model/view/result_three/result_three.dart';

class QuestionThree extends StatefulWidget {
  const QuestionThree({Key? key}) : super(key: key);

  @override
  State<QuestionThree> createState() => _QuestionScreenState();
}

class _QuestionScreenState extends State<QuestionThree> {
  int questionindex = 0;
  int? selectedindex;
  int count = 0;
  int rightanswer = 0;
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: Text(
              "${questionindex + 1}/${Questiondb.mathQuestions.length}",
              style: TextStyle(
        ...
        child: Column(
          children: [
            ...
            LinearProgressIndicator(
              value: (questionindex + 1) / Questiondb.mathQuestions.length,
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Text(
                  Questiondb.mathQuestions[questionindex]["question"]
                      .toString(),
                  style: TextStyle(
                    color: Colorconstant.mycustomwhite,
                    fontSize: 20,
            ...
            ListView.separated(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              Questiondb.mathQuestions[questionindex]
                                      ["options"][index]
                                  .toString(),
                              style: TextStyle(
                                color: Colorconstant.mycustomwhite,
              ...
              itemCount:
                  Questiondb.mathQuestions[questionindex]["options"].length,
            ),
            ...
            ElevatedButton(
              ...
              onPressed: () {
                if (selectedindex != null &&
                    selectedindex ==
                        Questiondb.mathQuestions[questionindex]["answer"]) {
                  count++;
                }
                selectedindex = null;
                if (questionindex + 1 < Questiondb.mathQuestions.length) {
                  setState(() {
                    questionindex++;
                  });
                } else {
