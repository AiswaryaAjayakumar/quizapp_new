      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: Text(
              "${questionindex + 1}/${Questiondb.historyQuestions.length}",
              style: TextStyle(
        ...
        child: Column(
          children: [
            ...
            LinearProgressIndicator(
              value: (questionindex + 1) / Questiondb.historyQuestions.length,
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Text(
                  Questiondb.historyQuestions[questionindex]["question"]
                      .toString(),
                  style: TextStyle(
                    color: Colorconstant.mycustomwhite,
                    fontSize: 20,
            ...
            ListView.separated(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              Questiondb.historyQuestions[questionindex]
                                      ["options"][index]
                                  .toString(),
                              style: TextStyle(
                                color: Colorconstant.mycustomwhite,
              ...
              itemCount:
                  Questiondb.historyQuestions[questionindex]["options"].length,
            ),
            ...
            ElevatedButton(
              ...
              onPressed: () {
                if (selectedindex != null &&
                    selectedindex ==
                        Questiondb.historyQuestions[questionindex]["answer"]) {
                  count++;
                }
                selectedindex = null;
                if (questionindex + 1 < Questiondb.historyQuestions.length) {
                  setState(() {
                    questionindex++;
                  });
                } else {
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    if (questionindex + 1 <
                        Questiondb.historyQuestions.length) {
                      setState(() {
                        questionindex++;
                        selectedindex = null;
                      });
