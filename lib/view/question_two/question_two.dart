...
class _QuestionScreenState extends State<Questiontwo> {
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: Text(
              "${questionindex + 1}/${Questiondb.chemistryquestions.length}",
              style: TextStyle(
        ...
        child: Column(
          children: [
            ...
            LinearProgressIndicator(
              value: (questionindex + 1) / Questiondb.chemistryquestions.length,
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Text(
                  Questiondb.chemistryquestions[questionindex]["question"]
                      .toString(),
                  style: TextStyle(
                    color: Colorconstant.mycustomwhite,
                    fontSize: 20,
            ...
            ListView.separated(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              Questiondb.chemistryquestions[questionindex]
                                      ["options"][index]
                                  .toString(),
                              style: TextStyle(
                                color: Colorconstant.mycustomwhite,
              ...
              itemCount: Questiondb
                  .chemistryquestions[questionindex]["options"].length,
            ),
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                selectedindex = null;
                if (questionindex + 1 < Questiondb.chemistryquestions.length) {
                  setState(() {
                    questionindex++;
                  });
                } else {
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    if (questionindex + 1 <
                        Questiondb.chemistryquestions.length) {
                      setState(() {
                        questionindex++;
                        selectedindex = null;
                      });
  ...
  Color getcolor(int index) {
    if (selectedindex != null &&
        index == Questiondb.chemistryquestions[questionindex]["answer"]) {
      return Colorconstant.mycustomgreen;
    }
    if (selectedindex == index) {
      if (selectedindex ==
          Questiondb.chemistryquestions[questionindex]["answer"]) {
        return Colorconstant.mycustomgreen;
      } else {
        return Colors.red;
      }
